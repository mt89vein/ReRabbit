...
{
    public class RetryAcknowledgementBehaviour : IAcknowledgementBehaviour
    {
        /// <summary>
        /// Настройки очереди.
        /// </summary>
        ...
        /// <summary>
        /// Создает экземпляр класса <see cref="RetryAcknowledgementBehaviour"/>.
        /// </summary>
        /// <param name="queueSettings">Настройки очереди.</param>
        public RetryAcknowledgementBehaviour(QueueSetting queueSettings)
        {
