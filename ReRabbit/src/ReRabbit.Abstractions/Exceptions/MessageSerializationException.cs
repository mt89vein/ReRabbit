...
namespace ReRabbit.Abstractions.Exceptions
{
    ...
    public class MessageSerializationException : Exception
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="MessageSerializationException" /> class.</summary>
        public MessageSerializationException()
        {
        }

        /// <summary>Initializes a new instance of the <see cref="MessageSerializationException" /> class with serialized data.</summary>
        /// <param name="info">
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageSerializationException" /> class with a specified error
        /// message.
        /// </summary>
